...
const switchToTeam = (team) => {
    router.put(route('admin.current-team.update'), {
        team_id: team.id,
    }, {
        preserveState: false,
    });
                                ...
                                <Dropdown v-if="$page.props.jetstream.hasTeamFeatures" align="right" width="60">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <!-- Team Settings -->
                                            <DropdownLink :href="route('admin.teams.show', $page.props.auth.user.current_team)">
                                                Team Settings
                                            </DropdownLink>

                                            <DropdownLink v-if="$page.props.jetstream.canCreateTeams" :href="route('admin.teams.create')">
                                                Create New Team
                                            </DropdownLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('admin.profile.show')">
                                プロフィール
                            </ResponsiveNavLink>
